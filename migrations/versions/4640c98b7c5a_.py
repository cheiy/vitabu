...
Revision ID: 4640c98b7c5a
Revises: 8b582217e4b4
Create Date: 2023-07-08 19:50:07.771316
...
revision = '4640c98b7c5a'
down_revision = '8b582217e4b4'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    with op.batch_alter_table('publishers', schema=None) as batch_op:
        ...
        batch_op.alter_column('user_id', new_column_name='added_by',existing_type=mysql.BIGINT())"""
        """batch_op.drop_column('ISBN')
        batch_op.alter_column('ISBN', new_column_name='ISBN_code', existing_type=mysql.BIGINT())"""

    with op.batch_alter_table('subjects', schema=None) as batch_op:
        """
        batch_op.add_column(sa.Column('subject_id', sa.Integer(), nullable=False))
        batch_op.drop_column('id')
        batch_op.alter_column('id', existing_type=mysql.BIGINT(), new_column_name='subject_id', nullable=False)"""
